...
def fire():
    ...
    while fired == True:
        ...
        pygame.draw.line(gameDisplay, red, (mainUFOX - UFOXfiredMovement, mainUFOY - UFOshotStart),
                         (mainUFOX - UFOXfiredMovement, mainUFOY - UFOshotEnd), turretWidth)
        UFOshotEnd += 20
        UFOshotStart += 20
        ...
        if enemyUFOX + (UFOWidth / 2) >= mainUFOX - UFOXfiredMovement >= enemyUFOX - (
                UFOWidth / 2) and mainUFOY - UFOshotStart == enemyUFOY:
            newScore += 1
